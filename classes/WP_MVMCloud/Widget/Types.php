...
class Types extends Widget
{
    ...
    protected function configure($prefix = '', $params = array())
    {
        ...
        $this->title = $prefix . __('Types', 'wp-mvmcloud') . ' (' . __($timeSettings['description'], 'wp-mvmcloud') . ')';
    ...
    public function show()
    {
        ...
        if (!empty($response['result']) && $response['result'] = 'error')
            ...
            $tableHead = array(__('Type', 'wp-mvmcloud'), __('Unique', 'wp-mvmcloud'), __('Percent', 'wp-mvmcloud'));
