<?php
	...
	class Models extends Widget {
		...
		protected function configure($prefix = '', $params = array()) {
			...
			$this->title = $prefix.__('Models', 'wp-mvmcloud').' ('.__($timeSettings['description'],'wp-mvmcloud').')';
		...
		public function show() {
			...
			if (!empty($response['result']) && $response['result'] ='error')
				...
				$tableHead = array(__('Model', 'wp-mvmcloud'), __('Unique', 'wp-mvmcloud'), __('Percent', 'wp-mvmcloud'));
