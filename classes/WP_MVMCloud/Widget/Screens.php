<?php
	...
	class Screens extends \WP_MVMCloud\Widget {
		...
		protected function configure($prefix = '', $params = array()) {
			...
			$this->title = $prefix.__('Resolutions', 'wp-mvmcloud').' ('.__($timeSettings['description'],'wp-mvmcloud').')';
		...
		public function show() {
			...
			if (!empty($response['result']) && $response['result'] ='error')
				...
				$tableHead = array(__('Resolution', 'wp-mvmcloud'), __('Unique', 'wp-mvmcloud'), __('Percent', 'wp-mvmcloud'));
